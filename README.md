...
> 面向中文玩家的高风险模拟交易训练系统：$500 纸面账户、期权真实度、策略实验室、数据可信度、风险驾驶舱、AI 三方审判和交易日记。Phase 1 仅模拟，不自动下真钱单。

English:

> Paper-only high-risk trading research cockpit with options realism, forward ledger, strategy lab, source trust, risk cockpit, AI tribunal, and trade journal.
